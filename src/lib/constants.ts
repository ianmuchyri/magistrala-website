...
export const useCasesData = [
    {
        title: "Smart Cities",
        description: "Manage traffic flow, monitor air quality, and optimize energy usage across urban environments.",
    ...
    {
        title: "Smart Energy",
        description: "Deliver and store data from smart meters in reliable and fault-tolerant way, visualize real-time and historical energy consumption data on customizable end-user dashboards.",
    ...
    },
    {
        ...
        description: "Monitor and control industrial equipment, optimize production processes, and predict maintenance needs in real-time.",
    ...
    features: [
        {
            ...
            description: "Optimized for lightning-fast message delivery, ensuring real-time communication.",
            icon: "fast-icon.jpg",
        },
        {
            title: "Multi-Protocol Messaging",
