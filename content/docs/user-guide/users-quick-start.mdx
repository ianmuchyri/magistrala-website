...
We will delve deeper into Domains in [another section](./domain-management/domain). For now you need to be able to log into a Domain to move on to **Groups**.
...
> More information about Rules Creation and Updating can be found in the [Rules Engine Section](./rules-engine)
