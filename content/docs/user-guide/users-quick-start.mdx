...
We will delve deeper into Domains in [another section](/docs/user-guide/domain-management/domain). For now you need to be able to log into a Domain to move on to **Groups**.
...
> More information about Rules Creation and Updating can be found in the [Rules Engine Section](/docs/user-guide/rules-engine)
...
More information on how to send messages via the terminal can be found in the **Developer Docs**, under the [**Messaging section** in **Developer Tools**](/docs/dev-guide/api/#messages).
