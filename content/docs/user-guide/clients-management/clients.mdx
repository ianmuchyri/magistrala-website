...
Bootstrap configuration of a client allows bootstrapping of the device (self-starting process that proceeds without external input). Further details of bootstrapping are discussed in the [Bootstrap section](bootstraps).
...
For detailed instructions on managing alarms, see the [Alarms documentation](../alarms#view-alarms).
...
![Delete Client](../../img/clients/client-delete.png)