...
To set metadata on a channel so it is recognized and displayed correctly by the Magistrala UI:

```bash
magistrala-cli channels update <channel_id> '{"metadata":{"<key>":{"value":"<value>","type":"string","updatedAt":"<timestamp>"}}}' <domain_id> <user_token>
```

Example usage:

```bash
magistrala-cli channels update 41a64d0c-5ac6-42d7-bff6-0d4d2828416e '{"metadata":{"location":{"value":"london","type":"string","updatedAt":"2026-01-01T00:00:00.000Z"}}}' 9879f314-8b0a-4a11-b157-8523491ffa81 token
```
